...
Casper 的两种版本 Casper FFG 和 Casper CBC，详情见[本文][5]。
...
以太坊的 PoA 算法被称作 Clique 协议，协议的描述在[这里][6]，它还产生了一个[Rinkeby test network][7]。这个测试网络每15秒出一个块，和主网的`ethash`想要达到的目标一致。

是不是 PoS 永远不能升级到 PoA 了？PoA 是不是就是为了联盟链设计的？

另外一篇[描述了 Clique 用法的文][8]。
...
### DPoS（Delegated Proof of Stake） ###
  ...
  [3]: https://github.com/ethereum/wiki/wiki/Proof-of-Stake-FAQ
  [4]: http://www.8btc.com/proof-stake-learned-love-weak-subjectivity
  [5]: https://blockgeeks.com/guides/ethereum-casper/
  [6]: https://github.com/ethereum/EIPs/issues/225
  [7]: https://rinkeby.io/
  [8]: http://blog.enuma.io/update/2017/08/29/proof-of-authority-ethereum-networks.html
  [9]: https://github.com/ethereum/EIPs/issues/225